...
contract RaffleTest is Test, CodeConstants {
    ...
    function testRaffleGetPlayerWhenNoPlayer() public {
        vm.expectRevert(Raffle.Raffle__InvalidPlayerIndex.selector);
        raffle.getPlayer(0);
    }
    ...
    function testPerformUpkeepUpdatesRaffleStateAndEmitsRequestId() public {
        ...
        // entries[0]: "event RaffleEnter"
        // entries[1]: "event RequestedRaffleWinner"
    ...
    modifier skipFork() {
        if (block.chainid != 31337) {
            // 31337 is the chain id for local
            return;
        }
        _;
    }
    ...
    function testFulfillRandomWordsPicksAWinnerResetsAndSendsMoney() public raffleEntered skipFork {
        ...
        uint256 endIndex = startingIndex + additionalEntrances;
        ...
        raffle.performUpkeep(""); // emits requestId
        Vm.Log[] memory entries = vm.getRecordedLogs();
        // console2.log("The following logs were request:");
